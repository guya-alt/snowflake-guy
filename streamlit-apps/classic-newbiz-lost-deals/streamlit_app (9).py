...
with st.sidebar:
    ...
    deal_names = sorted(df["DEAL_NAME"].dropna().unique().tolist())
    selected_deals = st.multiselect("Deal Name", deal_names, default=[])
...
filtered = df[
    ...
    & (df["DEAL_NAME"].isin(selected_deals) if selected_deals else True)
    & (
